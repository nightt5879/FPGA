...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../led.gen/sources_1/ip/ila/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../led.gen/sources_1/ip/ila/hdl/verilog" \
...
reset_run()
{
  files_to_remove=(ucli.key ila_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_simv.daidir vcs_lib c.obj)
