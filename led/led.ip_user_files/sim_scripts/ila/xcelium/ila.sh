...
#
# Script generated by Vivado on Thu Jun 20 09:45:58 +0800 2024
...
#
# Usage        : ila.sh
#                ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila.sh [-reset_run]
#                ila.sh [-reset_log]
#                ila.sh [-help]
#
...
#                script (type 'ila.sh -help' for more information).
#
...
# script info
echo -e "ila.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../led.gen/sources_1/ip/ila/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../led.gen/sources_1/ip/ila/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila.sh [-reset_log]\n\
Usage: ila.sh [-keep_index]\n\
