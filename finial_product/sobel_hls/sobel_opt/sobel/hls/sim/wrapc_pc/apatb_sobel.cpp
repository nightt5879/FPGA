...
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.sobel.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.sobel.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.sobel.autotvout_gmem.dat"
...
extern "C"
void sobel_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
void apatb_sobel_hw(void* __xlx_apatb_param_src, void* __xlx_apatb_param_dst, hls::sim::Byte<4> __xlx_apatb_param_rows, hls::sim::Byte<4> __xlx_apatb_param_cols)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_src;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_src),
#endif
  };
  port0.param = &__xlx_offset_byte_param_src;

  hls::sim::Byte<4> __xlx_offset_byte_param_dst;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dst),
#endif
  };
  port1.param = &__xlx_offset_byte_param_dst;
  ...
  __xlx_offset_byte_param_src = 0*1;
  __xlx_offset_byte_param_dst = 921600*1;
  port4.param = { __xlx_apatb_param_src, __xlx_apatb_param_dst };
  port4.nbytes = { 921600, 917604 };
  port4.offset = { 0, 921600 };
