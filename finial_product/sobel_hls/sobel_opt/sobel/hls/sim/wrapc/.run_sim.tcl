...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel.autotvin.dat"
	set constFileTvOut       "sobel.autotvout.dat"
	set constFileHdlTvIn     "sobel.autohdltvin.dat"
	set constFileHdlTvOut    "sobel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
