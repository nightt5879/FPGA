...
HLS_SOURCES = ../../../../../source/sobel_tb.cpp ../../../../../source/sobel_base.cpp
...
$(ObjDir)/sobel_tb.o: ../../../../../source/sobel_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../source/sobel_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sobel_tb.d

$(ObjDir)/sobel_base.o: ../../../../../source/sobel_base.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../source/sobel_base.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/sobel_base.d
