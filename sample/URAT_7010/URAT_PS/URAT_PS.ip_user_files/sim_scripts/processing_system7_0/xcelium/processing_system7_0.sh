...
#
# Script generated by Vivado on Tue Nov 05 20:35:02 +0800 2024
...
#
# Usage        : processing_system7_0.sh
#                processing_system7_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                processing_system7_0.sh [-reset_run]
#                processing_system7_0.sh [-reset_log]
#                processing_system7_0.sh [-help]
#
...
#                script (type 'processing_system7_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "processing_system7_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./processing_system7_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.processing_system7_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.processing_system7_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log processing_system7_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: processing_system7_0.sh [-step]\n\
Usage: processing_system7_0.sh [-lib_map_path]\n\
Usage: processing_system7_0.sh [-reset_run]\n\
Usage: processing_system7_0.sh [-reset_log]\n\
Usage: processing_system7_0.sh [-keep_index]\n\
