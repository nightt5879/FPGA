...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../UART_IP.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
