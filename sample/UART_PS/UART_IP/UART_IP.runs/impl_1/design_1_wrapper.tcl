namespace eval ::optrace {
  variable script "E:/robot/project/FPGA/sample/UART_PS/UART_IP/UART_IP.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir E:/robot/project/FPGA/sample/UART_PS/UART_IP/UART_IP.cache/wt [current_project]
  set_property parent.project_path E:/robot/project/FPGA/sample/UART_PS/UART_IP/UART_IP.xpr [current_project]
  set_property ip_output_repo E:/robot/project/FPGA/sample/UART_PS/UART_IP/UART_IP.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet E:/robot/project/FPGA/sample/UART_PS/UART_IP/UART_IP.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files E:/robot/project/FPGA/sample/UART_PS/UART_IP/UART_IP.srcs/sources_1/bd/design_1/design_1.bd
