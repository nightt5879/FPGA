...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_pkg_v1_0_4 -libname lib_srl_fifo_v1_0_4 -libname lib_cdc_v1_0_3 -libname axi_uartlite_v2_0_35 -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_register_slice_v2_1_31 -libname axi_protocol_converter_v2_1_31 -libname proc_sys_reset_v5_0_15 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_sample.gen/sources_1/bd/UART/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_sample.gen/sources_1/bd/UART/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_sample.gen/sources_1/bd/UART/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../UART_sample.gen/sources_1/bd/UART/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/ec67/hdl" +incdir+"../../../../UART_sample.gen/sources_1/bd/UART/ipshared/b28c/hdl" +incdir+"E:/vivado/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.UART xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.UART -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log UART_sc.so .tmp_log xcelium_lib waves.shm c.obj)
