...
__attribute__((sdx_kernel("yuv_filter", 0))) void yuv_filter (
  image_t *in,
  image_t *out,
  yuv_scale_t Y_scale,
  yuv_scale_t U_scale,
...
{
#line 37 "E:/robot/project/FPGA/ZedBoard/HLS_lab/source/test/lab2/pynq_yuv_filter.tcl"
#pragma HLSDIRECTIVE TOP name=yuv_filter
# 37 "yuv_filter.c"
