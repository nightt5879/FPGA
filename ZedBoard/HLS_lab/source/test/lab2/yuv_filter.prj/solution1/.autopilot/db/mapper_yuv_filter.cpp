...
using hls::sim::Byte;
extern "C" void yuv_filter(Byte<1>*, Byte<1>*, Byte<1>*, volatile void *, volatile void *, Byte<1>*, Byte<1>*, Byte<1>*, volatile void *, volatile void *, char, char, char);
...
std::vector<Byte<1>> __xlx_in_channels_ch1__tmp_vec;
for (size_t i = 0; i < 2457600; ++i){
__xlx_in_channels_ch1__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_in_channels_ch1)[i]);
}
...
std::vector<Byte<1>> __xlx_in_channels_ch2__tmp_vec;
for (size_t i = 0; i < 2457600; ++i){
__xlx_in_channels_ch2__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_in_channels_ch2)[i]);
}
...
std::vector<Byte<1>> __xlx_in_channels_ch3__tmp_vec;
for (size_t i = 0; i < 2457600; ++i){
__xlx_in_channels_ch3__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_in_channels_ch3)[i]);
}
...
std::vector<Byte<1>> __xlx_out_channels_ch1__tmp_vec;
for (size_t i = 0; i < 2457600; ++i){
__xlx_out_channels_ch1__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_out_channels_ch1)[i]);
}
...
std::vector<Byte<1>> __xlx_out_channels_ch2__tmp_vec;
for (size_t i = 0; i < 2457600; ++i){
__xlx_out_channels_ch2__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_out_channels_ch2)[i]);
}
...
std::vector<Byte<1>> __xlx_out_channels_ch3__tmp_vec;
for (size_t i = 0; i < 2457600; ++i){
__xlx_out_channels_ch3__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_out_channels_ch3)[i]);
}
  ...
  // DUT call
  yuv_filter(__xlx_in_channels_ch1__tmp_vec.data(), __xlx_in_channels_ch2__tmp_vec.data(), __xlx_in_channels_ch3__tmp_vec.data(), __xlx_apatb_param_in_width, __xlx_apatb_param_in_height, __xlx_out_channels_ch1__tmp_vec.data(), __xlx_out_channels_ch2__tmp_vec.data(), __xlx_out_channels_ch3__tmp_vec.data(), __xlx_apatb_param_out_width, __xlx_apatb_param_out_height, __xlx_apatb_param_Y_scale, __xlx_apatb_param_U_scale, __xlx_apatb_param_V_scale);
// print __xlx_apatb_param_in_channels_ch1
for (size_t i = 0; i < __xlx_size_param_in_channels_ch1; ++i) {
((Byte<1>*)__xlx_apatb_param_in_channels_ch1)[i] = __xlx_in_channels_ch1__tmp_vec[__xlx_offset_param_in_channels_ch1+i];
}
// print __xlx_apatb_param_in_channels_ch2
for (size_t i = 0; i < __xlx_size_param_in_channels_ch2; ++i) {
((Byte<1>*)__xlx_apatb_param_in_channels_ch2)[i] = __xlx_in_channels_ch2__tmp_vec[__xlx_offset_param_in_channels_ch2+i];
}
// print __xlx_apatb_param_in_channels_ch3
for (size_t i = 0; i < __xlx_size_param_in_channels_ch3; ++i) {
((Byte<1>*)__xlx_apatb_param_in_channels_ch3)[i] = __xlx_in_channels_ch3__tmp_vec[__xlx_offset_param_in_channels_ch3+i];
}
// print __xlx_apatb_param_out_channels_ch1
for (size_t i = 0; i < __xlx_size_param_out_channels_ch1; ++i) {
((Byte<1>*)__xlx_apatb_param_out_channels_ch1)[i] = __xlx_out_channels_ch1__tmp_vec[__xlx_offset_param_out_channels_ch1+i];
}
// print __xlx_apatb_param_out_channels_ch2
for (size_t i = 0; i < __xlx_size_param_out_channels_ch2; ++i) {
((Byte<1>*)__xlx_apatb_param_out_channels_ch2)[i] = __xlx_out_channels_ch2__tmp_vec[__xlx_offset_param_out_channels_ch2+i];
}
// print __xlx_apatb_param_out_channels_ch3
for (size_t i = 0; i < __xlx_size_param_out_channels_ch3; ++i) {
((Byte<1>*)__xlx_apatb_param_out_channels_ch3)[i] = __xlx_out_channels_ch3__tmp_vec[__xlx_offset_param_out_channels_ch3+i];
}
}
