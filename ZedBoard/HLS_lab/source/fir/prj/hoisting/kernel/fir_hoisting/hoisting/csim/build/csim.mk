...
HLS_SOURCES = ../../../../fir_tb.cpp ../../../../fir_hoisting.cpp
...
$(ObjDir)/fir_hoisting.o: ../../../../fir_hoisting.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../fir_hoisting.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fir_hoisting.d
