...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fir_wrap.autotvin_gmem.dat"
         "c.fir_wrap.autotvin_y.dat"
         "c.fir_wrap.autotvin_x.dat"
         "c.fir_wrap.autotvin_len.dat"
         "c.fir_wrap.autotvin_coef.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fir_wrap.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
