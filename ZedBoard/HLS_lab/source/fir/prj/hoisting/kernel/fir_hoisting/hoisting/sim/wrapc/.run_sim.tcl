...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fir_wrap.autotvin.dat"
	set constFileTvOut       "fir_wrap.autotvout.dat"
	set constFileHdlTvIn     "fir_wrap.autohdltvin.dat"
	set constFileHdlTvOut    "fir_wrap.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
