...
extern "C"
void fir_wrap_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>, void*);

extern "C"
void apatb_fir_wrap_hw(void* __xlx_apatb_param_y, void* __xlx_apatb_param_x, hls::sim::Byte<4> __xlx_apatb_param_len, void* __xlx_apatb_param_coef)
{
  ...
  port2.param = &__xlx_apatb_param_len;

  hls::sim::Byte<4> __xlx_offset_byte_param_coef;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_coef),
#endif
  };
  port3.param = &__xlx_offset_byte_param_coef;
  ...
  port4.param = { __xlx_apatb_param_y, __xlx_apatb_param_x, __xlx_apatb_param_coef };
  port4.nbytes = { 400, 400, 396 };
