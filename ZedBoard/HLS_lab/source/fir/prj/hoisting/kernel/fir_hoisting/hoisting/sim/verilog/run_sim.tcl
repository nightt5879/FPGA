...
if {[file isfile fir_wrap.autotvin.dat]} {
	file delete -force fir_wrap.autotvin.dat
}

if {[file isfile fir_wrap.autotvout.dat]} {
	file delete -force fir_wrap.autotvout.dat
}
