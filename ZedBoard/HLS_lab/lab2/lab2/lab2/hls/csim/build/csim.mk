...
HLS_SOURCES = ../../../../../../source/lab2/yuv_filter_test.c ../../../../../../source/lab2/yuv_filter.c ../../../../../../source/lab2/image_aux.c
...
$(ObjDir)/yuv_filter_test.o: ../../../../../../source/lab2/yuv_filter_test.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../source/lab2/yuv_filter_test.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yuv_filter_test.d

$(ObjDir)/yuv_filter.o: ../../../../../../source/lab2/yuv_filter.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../source/lab2/yuv_filter.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yuv_filter.d

$(ObjDir)/image_aux.o: ../../../../../../source/lab2/image_aux.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../source/lab2/image_aux.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
