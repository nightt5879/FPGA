...
HLS_SOURCES = ../../../../../../source/lab4/fir_test.c ../../../../../../source/lab4/fir.c
...
$(ObjDir)/fir_test.o: ../../../../../../source/lab4/fir_test.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../source/lab4/fir_test.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fir_test.d

$(ObjDir)/fir.o: ../../../../../../source/lab4/fir.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../source/lab4/fir.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
