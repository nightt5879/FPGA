set moduleName dct_Pipeline_WR_Loop_Row_WR_Loop_Col
set isTopModule 0
...
set C_modelName {dct_Pipeline_WR_Loop_Row_WR_Loop_Col}
...
set C_modelArgList {
	{ buf_2d_out int 16 regular {array 64 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	buf_2d_out { ap_memory {  { buf_2d_out_address0 mem_address 1 6 }  { buf_2d_out_ce0 mem_ce 1 1 }  { buf_2d_out_q0 mem_dout 0 16 } } }
