...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../lab_6.gen/sources_1/ip/ila_led/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_led xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_led -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_led_sc.so .tmp_log xcelium_lib waves.shm c.obj)
