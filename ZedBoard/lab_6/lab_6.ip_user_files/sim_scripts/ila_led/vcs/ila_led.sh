...
#
# Script generated by Vivado on Sat Oct 05 12:03:14 +0800 2024
...
#
# Usage        : ila_led.sh
#                ila_led.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_led.sh [-reset_run]
#                ila_led.sh [-reset_log]
#                ila_led.sh [-help]
#
...
#                script (type 'ila_led.sh -help' for more information).
#
...
# script info
echo -e "ila_led.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_led.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../lab_6.gen/sources_1/ip/ila_led/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_led xil_defaultlib.glbl -o ila_led_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_led_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_led_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_led_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_led.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_led.sh [-help]\n\
Usage: ila_led.sh [-step]\n\
Usage: ila_led.sh [-lib_map_path]\n\
Usage: ila_led.sh [-reset_run]\n\
Usage: ila_led.sh [-reset_log]\n\
Usage: ila_led.sh [-keep_index]\n\
Usage: ila_led.sh [-noclean_files]\n\n\
