...
在串口窗口中输入：M+电流，就可以使得M1电机闭环转动，电流单位为A
...
void setup() {
  ...
  I2Cone.begin(23, 5, 400000UL);  // AS5600_M1
  ...
  motor.monitor_variables = _MON_TARGET | _MON_VEL | _MON_ANGLE | _MON_CURR_Q;  // monitor target velocity and angle
