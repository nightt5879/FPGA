/**
Deng's FOC 电流闭环位置力矩互控 例程 测试库：SimpleFOC 2.2.1 测试硬件：DengFOC-V4
...
void loop() {
  ...
  // motor1.move( 0.4*(target_angle+motor2.shaft_angle - motor1.shaft_angle));
  motor1.move(0.4 * (motor2.shaft_angle - motor1.shaft_angle));
  motor2.move(0.4 * (motor1.shaft_angle - motor2.shaft_angle));
}
