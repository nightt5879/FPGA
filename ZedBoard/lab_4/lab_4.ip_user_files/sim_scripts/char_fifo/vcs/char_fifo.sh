...
design_libs=(fifo_generator_v10_0 xil_defaultlib)
...
compile()
{
  vlogan -work fifo_generator_v10_0 $vlogan_opts +v2k \
...
reset_run()
{
  files_to_remove=(ucli.key char_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc char_fifo_simv.daidir vcs_lib c.obj)
